" seagrey-light, a vim colourscheme by nightsense
"
...
if has('nvim')
  ...
  let g:terminal_color_6 =  '#289e8e'
  let g:terminal_color_7 =  '#51616b'
  let g:terminal_color_8 =  '#889094'
  let g:terminal_color_9 =  '#e07538'
  let g:terminal_color_10 = '#d7dde0'
  let g:terminal_color_11 = '#999c9e'
  let g:terminal_color_12 = '#6c7275'
  let g:terminal_color_13 = '#303a40'
  let g:terminal_color_14 = '#d46a85'
  let g:terminal_color_15 = '#1d262b'
endif
...
if filereadable(expand('~/.nightshell/seagrey-light'))
  if !has('gui_running')
    execute 'silent !/bin/sh $HOME/.nightshell/seagrey-light'
  endif
endif
...
augroup NightsenseThemeSet
   ...
   autocmd CursorMoved * execute 'if !exists("colors_name") |
         \ colorscheme seagrey-light | endif'
augroup END
let colors_name = 'seagrey-light'
...
if exists('g:seagrey_light_CursorLineNr')
if g:seagrey_light_CursorLineNr == 'off'
cal <sid>h('CursorLineNr'     , s:g4 , s:g1 , s:t4 , s:t1 , 'none'      , ''  )
endif
endif

" disable LineNr background altogether
if exists('g:seagrey_light_LineNr')
if g:seagrey_light_LineNr == 'off'
