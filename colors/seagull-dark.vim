" seagull-dark, a vim colourscheme by nightsense
"
...
if has('nvim')
  ...
  let g:terminal_color_8 =  '#636970'
  let g:terminal_color_9 =  '#d46a00'
  let g:terminal_color_10 = '#282c30'
  let g:terminal_color_11 = '#3d4752'
...
if !has('gui_running')
  execute 'silent !/bin/sh $HOME/.nightshell/seagull-dark'
  autocmd CursorMoved * execute 'if !exists("colors_name") |
        \ let colors_name = "seagull-dark" |
        \ colorscheme seagull-dark | endif'
endif
...
" line numbers
cal <sid>h('LineNr'           , s:g , s:g , s:t , s:t , 'none'      , ''  )
