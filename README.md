...
<div class="highlighter-rouge"><pre class="highlight"><code>let g:seagrey_dark_CursorLineNr = 'off'
...
<div class="highlighter-rouge"><pre class="highlight"><code>let g:seagrey_dark_LineNr = 'off'
